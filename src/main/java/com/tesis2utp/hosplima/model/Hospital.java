...
@Entity
@Table(name = "hospital",
        uniqueConstraints = {@UniqueConstraint(columnNames = "ipress")}
)
public class Hospital implements Serializable {
    ...
    public Hospital(Long id, String ipress, String nombre, String ubigeo, String departamento, String provincia, String distrito, String direccion, Double longitud, Double latitud, String horario, String telefono, String telefono_emergencia, String url, String ruc, String razon, String categoria, String clasificacion, String tipo, String diresa, String odsis, String disa, String red, String microred, String institucion, Integer camas) {
        this.id = id;
        this.ipress = ipress;
        this.nombre = nombre;
        this.ubigeo = ubigeo;
